  ...
  switch (action.type) {
    case types.NOTIFICATION_SET_SHOW:
      return {
        ...
        onCloseLabel: action.content.onCloseLabel
          ? action.content.onCloseLabel
          : state.onCloseLabel,
        onClickLabel: action.content.onClickLabel
          ? action.content.onClickLabel
          : state.onClickLabel,
        onClick: action.content.onClick
